...
public class DataCache {
  ...
  private rrexchanger rrexchanger;
  private CoinMarketCap coinMarketCap;

  public rrexchanger getrrexchanger(){
    return this.rrexchanger;
  }
  public synchronized void setrrexchanger(rrexchanger data){
    this.rrexchanger = data;
  }
  ...
  public boolean isEffeFXH(){
    ...
    return (System.currentTimeMillis()- rrexchanger.getCtime()) < effective_time_fxh;
  }
